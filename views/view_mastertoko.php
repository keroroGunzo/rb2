...
<div id="modal" class="modal fade effect-super-scaled" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bd-0 tx-14">
            ...
            <form method="post" id="frm" name="frm" data-models="mdl_mastertoko" data-hapus="mdl_deletetoko" data-getID="mdl_getidtoko" action=" javascript:" class="form-horizontal form-bordered">
