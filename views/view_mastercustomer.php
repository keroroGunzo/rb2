    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Master Data Customer</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick=" clearInput()">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" id="frm" name="frm" data-models="mdl_mastercustomer" data-hapus="mdl_deletecustomer" data-getID="mdl_getidcustomer" action=" javascript:" class="form-horizontal form-bordered">
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" data-json="nama_cust">
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">ALAMAT: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="address" data-json="alamat_cust">
                                </div>
                            </div><!-- col-6 -->

                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    <label class="form-control-label">NO. TELP: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="number" name="phone" data-json="phone">
                                </div>
                            </div><!-- col-8 -->
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    <label class="form-control-label">NPWP: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="npwp" data-json="npwp">
                                </div>
                            </div>
                        </div><!-- row -->
