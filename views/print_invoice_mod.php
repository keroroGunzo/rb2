...
<body>
    ...
    <div class="br-pagebody" style="color: black;">
                            ...
                            <td style="border:none;">
                                <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                                    ...
                                    <div style="text-align:right;">
                                        <img src="../img/tobaqonLogo.png" width="260" height="80"><br>
                                        <small>
                                            Taman Puspa Anggaswangi F2/14, Sukodono, Sidoarjo<br>
                                            Telp: 081214821000, 08814310001<br>
                                            Email: info@tobaqontrans.com
                                        </small>
                                    </div>
                                </div>
                                ...
                                <table style="width:100%; border:none;">
                                    <tr>
                                        <td style="width:50%; vertical-align:top;">
                                            ...
                                            <?= htmlspecialchars($header['nama_cust'] ?? '-') ?><br>
                                            <?= nl2br(htmlspecialchars($header['alamat_cust'] ?? '-')) ?><br>
                                            Tel: <?= htmlspecialchars($header['phone'] ?? '-') ?><br>
                                            Email: <?= htmlspecialchars($header['email'] ?? '-') ?>
                                        </td>
                                        <td style="width:50%; vertical-align:top;">
                                            <strong>Invoice Information:</strong><br>
                                            Invoice No: <?= htmlspecialchars($header['invoice_number']) ?><br>
                                            Job Order: <?= htmlspecialchars($header['jo_number'] ?? '-') ?><br>
                                            Issue Date: <?= !empty($header['invoice_date']) ? date('d F Y', strtotime($header['invoice_date'])) : '-' ?><br>
                                            Due Date: <?= !empty($header['due_date']) ? date('d F Y', strtotime($header['due_date'])) : '-' ?>
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        ?>
        <div style="margin-top: 20px;margin-left:60px; width: 95%;">
            <table style="width: 100%; border: none;">
                <tr>
